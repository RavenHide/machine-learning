...
if __name__ == '__main__':
    ...
    is_good_list = data[:, 9] == '是'
    is_bad_list = data[:, 9] == '否'
    ...
    plt.scatter(data[:, 7][is_good_list], data[:, 8][is_good_list], c='k', marker='o')
    plt.scatter(data[:, 7][is_bad_list], data[:, 8][is_bad_list], c='r', marker='x')
